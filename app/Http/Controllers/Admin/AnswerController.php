...
class AnswerController extends Controller
{
    public function index()
    {
        ...
        $answers = Answer::with(['type', 'question'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.answers.create', compact('questions', 'types'));
    }
    ...
    public function edit(Answer $answer)
    {
        ...
        $answer->load('type', 'question');

        return view('admin.answers.edit', compact('answer', 'questions', 'types'));
    }
